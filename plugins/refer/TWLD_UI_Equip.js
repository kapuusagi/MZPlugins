/*:
 * @plugindesc TWLDの装備画面
 * @help
 *      装備画面の動作とか書き換える。TWLD専用。
 *      ステータスとか。
 */
...
var TWLD = TWLD || {};
TWLD.UIEquip = TWLD.UIEquip || {};

if (typeof Window_Command === 'undefined') {
    var Window_Base = {};
    var Window_Command = {};
    var Window_ActorCommand = {};
    var Window_EquipSlot = {};
    var Window_EquipStatus = {};
    var Window_EquipItem = {};
    var Window_Help = {};

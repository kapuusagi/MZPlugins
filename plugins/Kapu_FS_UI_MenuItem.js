/*:ja
 * @target MZ 
 * @plugindesc FS向けアイテムメニューUIプラグイン
 * @author kapuusagi
 * @url https://github.com/kapuusagi/MZPlugins/tree/master/plugins
 * @base Kapu_IndependentItem
 * @orderAfter Kapu_IndependentItem
 * @base Kapu_FS_BaseSystem
 * @orderAfter Kapu_FS_BaseSystem
 ...
 * 変更履歴
 * ============================================
 * Version.0.1.0 FS向けに作成したものを移植して実装。
 */
/**
...
(() => {
    const pluginName = "Kapu_FS_UI_MenuItem";

/*:ja
 * @target MZ 
 * @plugindesc RangeDistanceをFSのシステムに適用するためのプラグイン。
 * @author kapuusagi
 ...
 * @base Kapu_FS_UI_Menu
 * @orderAfter Kapu_FS_UI_Menu
 * @base Kapu_FS_UI_Status
 * @orderAfter Kapu_FS_UI_Status
 * @base Kapu_FS_UI_Equip
 * @orderAfter Kapu_FS_UI_Equip
 * 
 * @param frontIconId
 * @text 前衛アイコンID
 ...
 */
(() => {
    const pluginName = "Kapu_FS_UI_RangeDistance";

 ...
 * 制作開始時、VisuStellaプラグインの存在を知らなかったため、実装してしたもの。
 * 高機能・信頼性が高いので、VisuStellaのItemCoreプラグインを使った方がいい。
 * http://www.yanfly.moe/wiki/Main_Menu_Core_VisuStella_MZ
 * 
 * Yanfly氏がMVでItemCoreとしてリリースしていたプラグインの、
 * 個別アイテムを実現するための実装を参考に作成してある。
